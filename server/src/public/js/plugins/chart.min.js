...
!(function (t, e) {
  ...
  function ve(t, e, i) {
    ...
    return (
      ...
      (t.currentDevicePixelRatio !== n || a.height !== o || a.width !== s) &&
        ((t.currentDevicePixelRatio = n), (a.height = o), (a.width = s), t.ctx.setTransform(n, 0, 0, n, 0, 0), !0)
    );
  }
  const we = (function () {
    let t = !1;
  ...
  class Qe {
    ...
    getMaximumSize(t, e, i, n) {
      return (
        (e = Math.max(0, e || t.width)), (i = i || t.height), { width: e, height: Math.max(0, n ? Math.floor(e / n) : i) }
      );
    }
    isAttached(t) {
      return !0;
  ...
  const gi = (t) => 0 === t || 1 === t,
    ...
    xi = {
      ...
      easeInOutExpo: (t) =>
        gi(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1))),
  ...
  function $i(t, e, i) {
    ...
    if (
      !(
        i &&
        ((l =
          1 === n ? Math.max(c - s, a - c) : 0 === e ? (t.getPixelForTick(1) - c) / 2 : (c - t.getPixelForTick(o - 1)) / 2),
        (c += o < e ? l : -l),
        c < s - r || c > a + r)
      )
    )
  ...
  class qi extends zi {
    ...
    calculateLabelRotation() {
      ...
      (a = e.offset ? t.maxWidth / n : f / (n - 1)),
        d + 6 > a &&
          ...
          (l = Math.sqrt(d * d + u * u)),
          (c = zt(
            Math.min(Math.asin(Math.min((h.highest.height + 6) / a, 1)), Math.asin(Math.min(r / l, 1)) - Math.asin(u / l))
          )),
    ...
    fit() {
      ...
      if (a) {
        ...
        if (
          (r ? ((e.width = t.maxWidth), (e.height = Yi(s) + a)) : ((e.height = t.maxHeight), (e.width = Yi(s) + a)),
    ...
    getContext(t) {
      ...
      return (
        e.$context ||
        (e.$context = ((n = e.chart.getContext()), (o = e), Object.assign(Object.create(n), { scale: o, type: 'scale' })))
      );
      var n, o;
    }
    _tickSize() {
      ...
      (function (t, e) {
        ...
        for (i = 0, n = t.length; i < n; ++i)
          (a = s),
            ...
            s &&
              ((o = t[i]),
              a && ((o.cp1x = gn(o.cp1x, e.left, e.right)), (o.cp1y = gn(o.cp1y, e.top, e.bottom))),
              r && ((o.cp2x = gn(o.cp2x, e.left, e.right)), (o.cp2y = gn(o.cp2y, e.top, e.bottom))));
      })(t, i);
  }
  function mn(t, e, i, n) {
      ...
      (m = e[t % a]),
        m.skip ||
          ...
          p !== x &&
            ...
            null !== _ && v() && (g.push(Mn({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)),
            (i = t),
            (x = p)));
          ...
          for (const r of t) {
            ...
            for (a = s + 1; a <= r.end; a++) {
              ...
              (l = Cn(i.setContext({ type: 'segment', p0: c, p1: h }))),
                On(l, t) && (o.push({ start: s, end: a - 1, loop: r.loop, style: t }), (t = l), (s = a - 1)),
                (c = h),
                (t = l);
            }
  ...
  function Qn(t) {
    return (
      Zn() && 'string' == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]),
  ...
  class eo {
    constructor(t, e) {
      ...
      (this.id = j()),
        ...
        (Jn[n.id] = n),
        l && c
          ? (a.listen(n, 'complete', Kn), a.listen(n, 'progress', Gn), n._initialize(), n.attached && n.update())
    ...
    _initializePlatform(t, e) {
      return e.platform
        ? new e.platform()
        : !Zn() || ('undefined' != typeof OffscreenCanvas && t instanceof OffscreenCanvas)
        ? new Je()
        : new ui();
    }
    clear() {
    ...
    _resize(t, e) {
      ...
      (i.width = a.width),
        ...
        ve(i, r, !0) &&
          (i.notifyPlugins('resize', { size: a }), Q(n.onResize, [i, a], i), i.attached && i._doResize() && i.render());
    }
    ensureScalesHaveIDs() {
    ...
    buildOrUpdateControllers() {
      ...
      for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
        ...
        if (
          ...
          Object.assign(i.prototype, { dataElementType: Ln.getElement(r), datasetElementType: o && Ln.getElement(o) }),
    ...
    update(t) {
      ...
      if (
        ((ut(o, s) && !!this._responsiveListeners === e.options.responsive) || (e.unbindEvents(), e.bindEvents()),
    ...
    render() {
      ...
      !1 !== t.notifyPlugins('beforeRender', { cancelable: !0 }) &&
        (a.has(t) ? t.attached && !a.running(t) && a.start(t) : (t.draw(), Kn({ chart: t })));
    }
    draw() {
      const t = this;
      let e;
    ...
    destroy() {
      ...
      t.config.clearCache(),
        e && (t.unbindEvents(), qt(e, i), t.platform.releaseContext(i), (t.canvas = null), (t.ctx = null)),
    ...
    updateElements(t, e, i, n) {
      ...
      for (let l = e; l < e + i; l++) {
        ...
        (c.skip = isNaN(f) || isNaN(g)),
          h && ((c.options = o.resolveDataElementOptions(l, e.active ? 'active' : n)), s && (c.options.radius = 0)),
      ...
      let { start: r, count: l } = (function (t, e, i) {
        ...
        if (t._sorted) {
          ...
          d && (o = Ht(Math.min(se(r, a.axis, c).lo, i ? n : se(e, l, a.getPixelForValue(c)).lo), 0, n - 1)),
            (s = u
              ? Ht(Math.max(se(r, a.axis, h).hi + 1, i ? 0 : se(e, l, a.getPixelForValue(h)).hi + 1), o, n) - o
              : n - o);
        }
  ...
  (po.id = 'line'),
    (po.defaults = { datasetElementType: 'line', dataElementType: 'point', showLine: !0, spanGaps: !1 }),
    ...
    Ro && 1 === e.segments.length
      ...
      : (function (t, e, i, n) {
          const { segments: o, options: s } = e,
            a = Lo(e);
          for (const r of o)
            Do(t, s, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + n - 1 }) && t.closePath(), t.stroke();
        })(t, e, i, n);
  }
  class zo extends zi {
    constructor(t) {
    ...
    draw(t, e, i, n) {
      ...
      (o.points || []).length &&
        s.borderWidth &&
        (t.save(), Eo(t, o, i, n), t.restore(), o.animated && ((o._pointsUpdated = !1), (o._path = void 0)));
    }
  }
  function Io(t, e, i, n) {
    const o = t.options,
  ...
  function Vo(t) {
    ...
    const i = {};
    return e
      ? ((e = t.horizontal ? Wo(e, 'left', 'right', t.base > t.x) : Wo(e, 'bottom', 'top', t.base < t.y)), (i[e] = !0), i)
      : i;
  }
  function Wo(t, e, i, n) {
    var o, s, a;
  ...
  (Uo.id = 'bar'),
    (Uo.defaults = { borderSkipped: 'start', borderWidth: 0, borderRadius: 0, enableBorderRadius: !0, pointStyle: void 0 }),
    ...
    return (t.scale || {}).getPointPositionForValue
      ? (function (t) {
          ...
          if (((h = 'start' === i ? a : 'end' === i ? r : U(i) ? i.value : e.getBaseValue()), n.grid.circular))
            return (
              (c = e.getPointPositionForValue(0, a)), new Qo({ x: c.x, y: c.y, radius: e.getDistanceFromCenterForValue(h) })
            );
  ...
  class ms extends zi {
    ...
    _fitCols(t, e, i, n) {
      ...
      return (
        o.legendItems.forEach((t, o) => {
          ...
          o > 0 && f + n + 2 * r > h && ((d += u + r), c.push({ width: u, height: f }), (g += u + r), p++, (u = f = 0)),
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        ...
        for (const a of i)
          r !== a.row && ((r = a.row), (l = o(n, t.left + s, t.right - t.lineWidths[r]))),
            (a.top += t.top + e + s),
            (a.left = l),
            (l += a.width + s);
        if (a) {
      ...
      t.legendItems.forEach((M, k) => {
        ...
        h.setWidth(t.width),
          y
            ...
            : k > 0 &&
              O + w > t.bottom &&
              ((C = m.x = C + i[m.line].width + f), m.line++, (O = m.y = o(r, t.top + v + f, t.bottom - i[m.line].height)));
        !(function (t, e, i) {
          ...
          if (
            ...
            const o = e + Math.max((g - b) / 2, 0),
              ...
              r = Ie(i.borderRadius);
            a.beginPath(),
              Object.values(r).some((t) => 0 !== t) ? ne(a, { x: s, y: o, w: x, h: b, radius: r }) : a.rect(s, o, x, b),
              a.fill(),
              0 !== n && a.stroke();
          }
          a.restore();
  ...
  class Fs extends qi {
    ...
    parse(t, e) {
      ...
      return ((t, e) =>
        null === t ? null : Ht(Math.round(t), 0, e))((e = isFinite(e) && i[e] === t ? e : Is(i, t, K(e, t))), i.length - 1);
    }
    determineDataLimits() {
      const t = this,
    ...
    buildTicks() {
      ...
      const o = (function (t, e) {
        ...
        for (
          m &&
          (d && v !== s
            ? (i.push({ value: s }), v < s && P++, At(Math.round((v + P * k) * y) / y, s, Bs(s, _, t)) && P++)
            : v < s && P++);
          P < M;
          ++P
        )
  ...
  class Zs extends Vs {
    ...
    drawBackground() {
      ...
      if (e) {
        ...
        n.save(),
          n.beginPath(),
          Ks(t, t.getDistanceFromCenterForValue(t._endValue), i, t.getLabels().length),
          n.closePath(),
          (n.fillStyle = e),
          n.fill(),
          n.restore();
  ...
  function ea(t, e) {
    ...
    return (
      ...
      null === a
        ? null
        : (o && (a = 'week' !== o || (!Tt(s) && !0 !== s) ? i.startOf(a, o) : i.startOf(a, 'isoWeek', s)), +a)
    );
  }
  function ia(t, e, i, n) {
    const o = Js.length;
  ...
  class ra extends sa {
    ...
    buildLookupTable(t) {
      ...
      for (s = 0, a = n.length; s < a; ++s)
        (c = n[s + 1]), (r = n[s - 1]), (l = n[s]), Math.round((c + r) / 2) !== l && o.push({ time: l, pos: s / (a - 1) });
      return o;
    }
