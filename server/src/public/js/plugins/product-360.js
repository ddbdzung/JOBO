...
!function () {
  ...
  function b(b) {
    ...
    var A = (this.turn = function (a) {
      (a = s(a)),
        ...
        (function d() {
          a !== l && c
            ? (z(s(l > a ? l - 1 : l + 1)), setTimeout(d, 'undefined' == typeof a ? b.playSpeed : b.speed))
            : a === l && ((m.frame = l = a), (c = !1), 'function' == typeof n.change && n.change(l, f));
        })();
    });
  ...
  function c(a, c) {
    return (
      (a = document.getElementById(a)), a.getAttribute('data-circlr') ? void 0 : ((c = c || {}), (c.element = a), new b(c))
    );
  }
