        ...
        for (var l = s.split(' '), o = 0; o < l.length; o += 1)
          for (var d = l[o], h = 0; h < this.length; h += 1) {
            var p = this[h],
              u = void 0;
            if (
              (!a && p.dom7Listeners ? (u = p.dom7Listeners[d]) : a && p.dom7LiveListeners && (u = p.dom7LiveListeners[d]),
              u && u.length)
            )
              ...
              if (t.slidesPerColumn > 1) {
                ...
                if ('row' === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
                  var D = Math.floor($ / (t.slidesPerGroup * t.slidesPerColumn)),
                    ...
                    N =
                      0 === D ? t.slidesPerGroup : Math.min(Math.ceil((h - D * z * t.slidesPerGroup) / z), t.slidesPerGroup);
    ...
    J = {
      ...
      setDragPosition: function (e) {
        var t,
          ...
          l = i.dragStartPos;
        (t =
          (i.getPointerPosition(e) - a.offset()[this.isHorizontal() ? 'left' : 'top'] - (null !== l ? l : r / 2)) / (n - r)),
      ...
      setTranslate: function (e, t) {
        ...
        function l(e) {
          ...
          'slide' === a.params.controller.by &&
            (a.controller.getInterpoldteFunction(e), (s = -a.controller.spline.interpoldte(-t))),
        ...
        for (var c = 0; c < s.length; c += 1) {
          ...
          if ((y <= 1 && y > -1 && ((u = 90 * v + 90 * y), n && (u = 90 * -v - 90 * y)), f.transform(T), d.slideShadows)) {
            ...
            0 === C.length && ((C = m('<div class="swiper-slide-shadow-' + (h ? 'left' : 'top') + '"></div>')), f.append(C)),
              0 === S.length &&
                ((S = m('<div class="swiper-slide-shadow-' + (h ? 'right' : 'bottom') + '"></div>')), f.append(S)),
    ...
    he = {
      setTranslate: function () {
        for (
          ...
          var T =
            'translate3d(' + E + 'px,' + b + 'px,' + w + 'px)  rotateX(' + g + 'deg) rotateY(' + v + 'deg) scale(' + x + ')';
      ...
      onThumbClick: function () {
        ...
        if (e) {
          ...
          if (!((i && m(i).hasClass(this.params.thumbs.slideThumbActiveClass)) || null == t)) {
            var s;
            if (
              ((s = e.params.loop ? parseInt(m(e.clickedSlide).attr('data-swiper-slide-index'), 10) : t), this.params.loop)
            ) {
              var a = this.activeIndex;
