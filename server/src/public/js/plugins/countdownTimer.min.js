...
!(function (t) {
  ...
  function o(o, _) {
    ...
    if (
      ...
      if (void 0 !== _.startDate && void 0 !== _.dateAndTime && void 0 === _.currentTime) {
        (window['startDate' + o.attr('id')] = new Date(M.startDate)),
          (window['endDate' + o.attr('id')] =
            null !== M.timeZone ? e(new Date(M.dateAndTime), M.timeZone) : new Date(M.dateAndTime));
      ...
      void 0 !== _.hours && void 0 === _.minutes && void 0 === _.seconds
        ...
        : void 0 !== _.hours && void 0 === _.minutes && void 0 !== _.seconds
        ? n(o, 'HS', M, a, _)
        : void 0 !== _.hours && void 0 !== _.minutes && void 0 !== _.seconds && n(o, 'HMS', M, u, _);
  }
    ...
    window['minutes_H' + n] === o.minutes && window['seconds_H' + n] === o.seconds && window['hours_H' + n] === o.hours
      ...
      : (v(t, (e = S(t, o, 0, 0, 0, window['hours_H' + n], window['minutes_H' + n], window['seconds_H' + n])), o),
        ...
        0 !== window['minutes_H' + n] &&
          ...
          (window['minutes_H' + n]--, (window['seconds_H' + n] = 60 - o.tickInterval)),
        0 === window['minutes_H' + n] &&
          window['seconds_H' + n] < 0 &&
          0 !== window['hours_H' + n] &&
          (window['hours_H' + n]--, (window['minutes_H' + n] = 59), (window['seconds_H' + n] = 60 - o.tickInterval)),
        ((0 === window['minutes_H' + n] && window['seconds_H' + n] < 0 && 0 === window['hours_H' + n]) ||
  ...
  function d(t, o) {
    var n = t.attr('id'),
      e = '';
    window['minutes_M' + n] === o.minutes && window['seconds_M' + n] === o.seconds
      ...
      : (v(t, (e = S(t, o, 0, 0, 0, 0, window['minutes_M' + n], window['seconds_M' + n])), o),
        ...
        0 !== window['minutes_M' + n] &&
          ...
          (window['minutes_M' + n]--, (window['seconds_M' + n] = 60 - o.tickInterval)),
        ((0 === window['minutes_M' + n] && window['seconds_M' + n] < 0) || !0 === t.data('countdowntimer').destroy) &&
          h(t, 'M', o)),
      (n = null);
  }
  function s(t, o) {
    ...
    window['minutes_HM' + n] === o.minutes && window['hours_HM' + n] === o.hours
      ? (v(t, (e = S(t, o, 0, 0, 0, window['hours_HM' + n], window['minutes_HM' + n], 0)), o),
        ...
        0 !== window['hours_HM' + n] && 0 === window['minutes_HM' + n]
          ? (window['hours_HM' + n]--, (window['minutes_HM' + n] = 59), (window['seconds_HM' + n] = 60 - o.tickInterval))
      ...
      : (v(t, (e = S(t, o, 0, 0, 0, window['hours_HM' + n], window['minutes_HM' + n], window['seconds_HM' + n])), o),
        ...
        0 !== window['minutes_HM' + n] &&
          ...
          (window['minutes_HM' + n]--, (window['seconds_HM' + n] = 60 - o.tickInterval)),
        0 === window['minutes_HM' + n] &&
          window['seconds_HM' + n] < 0 &&
          0 !== window['hours_HM' + n] &&
          (window['hours_HM' + n]--, (window['minutes_HM' + n] = 59), (window['seconds_HM' + n] = 60 - o.tickInterval)),
        ((0 === window['minutes_HM' + n] && window['seconds_HM' + n] < 0 && 0 === window['hours_HM' + n]) ||
          !0 === t.data('countdowntimer').destroy) &&
          h(t, 'HM', o)),
      (n = null);
  }
  function r(t, o) {
    var n = t.attr('id'),
      e = '';
    window['minutes_MS' + n] === o.minutes && window['seconds_MS' + n] === o.seconds
      ? (v(t, (e = S(t, o, 0, 0, 0, 0, window['minutes_MS' + n], window['seconds_MS' + n])), o),
        ...
        0 !== window['minutes_MS' + n] && 0 === window['seconds_MS' + n]
          ? (window['minutes_MS' + n]--, (window['seconds_MS' + n] = 60 - o.tickInterval))
          : 0 === window['minutes_MS' + n] && 0 === window['seconds_MS' + n]
          ? h(t, 'MS', o)
      ...
      : (v(t, (e = S(t, o, 0, 0, 0, 0, window['minutes_MS' + n], window['seconds_MS' + n])), o),
        ...
        0 !== window['minutes_MS' + n] &&
          ...
          (window['minutes_MS' + n]--, (window['seconds_MS' + n] = 60 - o.tickInterval)),
        ((0 === window['minutes_MS' + n] && window['seconds_MS' + n] < 0) || !0 === t.data('countdowntimer').destroy) &&
          h(t, 'MS', o)),
      (n = null);
  }
  function a(t, o) {
    ...
    window['seconds_HS' + n] === o.seconds && window['hours_HS' + n] === o.hours
      ? (v(t, (e = S(t, o, 0, 0, 0, window['hours_HS' + n], 0, window['seconds_HS' + n])), o),
        ...
        0 === window['hours_HS' + n] && 0 === window['seconds_HS' + n]
          ? h(t, 'HS', o)
          : 0 !== window['hours_HS' + n] && 0 === window['seconds_HS' + n]
          ? (window['hours_HS' + n]--, (window['minutes_HS' + n] = 59), (window['seconds_HS' + n] = 60 - o.tickInterval))
      ...
      : (v(t, (e = S(t, o, 0, 0, 0, window['hours_HS' + n], window['minutes_HS' + n], window['seconds_HS' + n])), o),
        ...
        0 !== window['minutes_HS' + n] &&
          ...
          (window['minutes_HS' + n]--, (window['seconds_HS' + n] = 60 - o.tickInterval)),
        0 === window['minutes_HS' + n] &&
          window['seconds_HS' + n] < 0 &&
          0 !== window['hours_HS' + n] &&
          (window['hours_HS' + n]--, (window['minutes_HS' + n] = 59), (window['seconds_HS' + n] = 60 - o.tickInterval)),
        ((0 === window['minutes_HS' + n] && window['seconds_HS' + n] < 0 && 0 === window['hours_HS' + n]) ||
          !0 === t.data('countdowntimer').destroy) &&
          h(t, 'HS', o)),
      (n = null);
  }
  function u(t, o) {
    var n = t.attr('id'),
      e = '';
    window['minutes_HMS' + n] === o.minutes && window['seconds_HMS' + n] === o.seconds && window['hours_HMS' + n] === o.hours
      ? (v(t, (e = S(t, o, 0, 0, 0, window['hours_HMS' + n], window['minutes_HMS' + n], window['seconds_HMS' + n])), o),
        ...
        0 === window['hours_HMS' + n] && 0 === window['minutes_HMS' + n] && 0 === window['seconds_HMS' + n]
          ? h(t, 'HMS', o)
          : 0 !== window['hours_HMS' + n] && 0 === window['minutes_HMS' + n] && 0 === window['seconds_HMS' + n]
          ? (window['hours_HMS' + n]--, (window['minutes_HMS' + n] = 59), (window['seconds_HMS' + n] = 60 - o.tickInterval))
          : 0 === window['hours_HMS' + n] && 0 !== window['minutes_HMS' + n] && 0 === window['seconds_HMS' + n]
          ? (window['minutes_HMS' + n]--, (window['seconds_HMS' + n] = 60 - o.tickInterval))
          : 0 !== window['hours_HMS' + n] && 0 !== window['minutes_HMS' + n] && 0 === window['seconds_HMS' + n]
          ? (window['minutes_HMS' + n]--, (window['seconds_HMS' + n] = 60 - o.tickInterval))
      ...
      : (v(t, (e = S(t, o, 0, 0, 0, window['hours_HMS' + n], window['minutes_HMS' + n], window['seconds_HMS' + n])), o),
        ...
        0 === window['minutes_HMS' + n] &&
          ...
          (window['hours_HMS' + n]--, (window['minutes_HMS' + n] = 59), (window['seconds_HMS' + n] = 60 - o.tickInterval)),
        ((0 === window['minutes_HMS' + n] && window['seconds_HMS' + n] < 0 && 0 === window['hours_HMS' + n]) ||
          !0 === t.data('countdowntimer').destroy) &&
          h(t, 'HMS', o)),
      (n = null);
  }
  ...
  function m(t, o) {
    ...
    window['countSeconds' + n].toString().length < 2 && (window['countSeconds' + n] = '0' + window['countSeconds' + n]),
      ...
      -1 == window['countSeconds' + n] &&
        (delete window['countSeconds' + n], clearInterval(window['timer_secondsTimer' + n])),
      (n = null);
  }
  function _(o, n) {
  ...
  function S(t, o, n, e, i, d, s, w) {
    ...
    var r =
      ...
      m =
        '!' === a[3]
          ? Math.round(Math.floor(r / 3600 - (2628e3 * c) / 3600 - (31536e3 * u) / 3600 - (86400 * l) / 3600))
          : 0,
      _ =
        '!' === a[4]
          ? Math.round(Math.floor(r / 60 - (3600 * m) / 60 - (86400 * l) / 60 - (2628e3 * c) / 60 - (31536e3 * u) / 60))
          : 0,
  ...
  function v(o, n, e) {
    ...
    if (
      ...
      for (
        var a = "<span class='timerDisplay label" + (n = n.split(e.timeSeparator)).length + "'>", u = [], c = 0;
        c < 6;
        c++
      )
  ...
  function h(t, o, n) {
    var e = t.attr('id');
    'withnoStart' === o
      ? (delete window['dateTime' + e], delete window['startTime' + e], clearInterval(window['timer_givenDate' + e]))
      : 'withStart' === o
      ? (delete window['startDate' + e], delete window['endDate' + e], clearInterval(window['timer_startDate' + e]))
  ...
  var f = {
    ...
    destroy: function () {
      this.data('countdowntimer', t.extend(!0, {}, t.fn.countdowntimer.defaults, { destroy: !0 }));
    },
    pause: function (o) {
      this.data('countdowntimer', t.extend(!0, {}, t.fn.countdowntimer.defaults, { pause: o })),
        H(t(this), t(this).data('typefunc').type, t(this).data('opts').opts, t(this).data('typefunc').func);
    },
    stop: function (o) {
      this.data('countdowntimer', t.extend(!0, {}, t.fn.countdowntimer.defaults, { stop: o })),
  ...
  (t.fn.countdowntimer = function (o) {
    return f[o]
      ...
      : (this.data('countdowntimer', t.extend(!0, {}, t.fn.countdowntimer.defaults, o)), f.init.apply(this, arguments));
  }),
