  ...
  (function (t) {
    ...
    (s.migrateVersion = '3.3.0'),
      n.console &&
        ...
        n.console.log(
          'JQMIGRATE: Migrate is installed' + (s.migrateMute ? '' : ' with logging active') + ', version ' + s.migrateVersion
        ));
    var r = {};
    function u(e) {
      var t = n.console;
      ...
      (s.fn.css = function (e, t) {
        ...
        return (
          ...
          'number' != typeof t ||
            ...
            u('Use%20of%20number-typed%20values%20is%20deprecated%20in%20jQuery.fn.html'),
    ...
    (s.event.props = []),
      ...
      s.fn.extend({
        ...
        undelegate: function (e, t, r) {
          return (
            u('jQuery.fn.undelegate() is deprecated'), 1 === arguments.length ? this.off(e, '**') : this.off(t, e || '**', r)
          );
        },
        hover: function (e, t) {
